...
function(){
	...
	h)):e.stop().fadeOut(h,function(){c(this).removeClass(j).css(y).css("opacity",1)}).eq(b).fadeIn(h,function(){c(this).addClass(j).css(x);
	a.after(b);
	n=b
	})
	};
...
h+"ms ease-in-out","-o-transition":"opacity "+h+"ms ease-in-out",
		...
		p=setInterval(function(){
			...
			a.pause&&f.hover(function(){
				...
				function(){
					...
					if(a.pager||a.manualControls)q.bind("click",function(b){b.preventDefault();a.pauseControls||m();b=q.index(this);n===b||c("."+j).queue("fx").length||(r(b),z(b))
